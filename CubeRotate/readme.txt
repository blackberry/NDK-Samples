...
Sample Description:
 ...
 The CubeRotate sample is an application that is designed to show you how to create a
 a 3D multi-colored cube using OpenGL ES.

 When you run the application, the application displays a cube that rotates on the screen.
