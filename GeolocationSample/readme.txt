GeolocationSample - Display current location data

========================================================================
Sample Description:
 
 The GeolocationSample is an application that demonstrates how to retrieve geolocation
 specific information, such as the latitude, longitude, altitude, and bearing of the tablet.
