...
Sample Description:
 ...
 The gesture sample is an application that is designed to show you how to 
 handle gestures on the screen.
 	
 When you run the application, different behaviors are triggered depending
 on the gesture used, such as tap, double-tap, and pinch. Information about 
 the gestures are also output to the debug console.
