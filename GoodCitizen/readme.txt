...
Sample Description:
 ...
 The GoodCitizen sample is an application that is designed to introduce you to a number of 
 common development practices that you can use in your own applications. 
 	
 When you run the application, the application displays a spinning cube that you can change the 
 color of by selecting different menu options.
