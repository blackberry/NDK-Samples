HelloWorldConsole - Print a string

========================================================================
Sample Description:

 The Hello World Console sample is an application that is designed to show you
 how to print a basic string using the Native SDK.

 When you run the application, "Hello World" is printed to the console.

 Feature summary
 - Configuring basic input and output
 - Verifing that the system is operating correctly
