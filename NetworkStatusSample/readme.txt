...
Sample Description:
 ...
 When you run the application, the application queries the device for the network
 status, prints the status to the console, and listens for changes to the status.
