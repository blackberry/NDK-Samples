Basic media playback - Play an MP3 file

========================================================================
Sample Description:
 
 The Play Audio sample is an application that is designed to show you how to 
 play a simple audio file (in this sample, an MP3 file) and use the audio mixer
 service, which is a service in the BlackBerry Platform Services library. 
 
 When you run the application, a sample MP3 file is played. The volume and
 mute status is adjusted during playback.
 
 Feature summary
 - Connecting and configuring the multimedia renderer
 - Configuring audio input and output
 - Starting and stopping audio playback
 - Adjusting the volume and mute status during playback
